...
public class ClothInfo2Activity extends AppCompatActivity {
    ...
    private String sleeve_value;
    private String collar_value;
    private String model_value;
    private String pattern_value;

    private static String IMAGEPATH = "http://192.168.1.66:8080/fashion_server/recommendPic2";
    private static String FEEDBACKPATH = "http://192.168.1.66:8080/fashion_server/getFeedbackLevel3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获取上一页面传递的信息
        Bundle bundle_fromWords = this.getIntent().getExtras();
        user_name = bundle_fromWords.getString("user_name");
        attr_value = bundle_fromWords.getStringArray("clothingInfo");
        length_value = bundle_fromWords.getString("length_value");
        sleeve_value = bundle_fromWords.getString("sleeve_value");
        collar_value = bundle_fromWords.getString("collar_value");
        model_value = bundle_fromWords.getString("model_value");
        pattern_value = bundle_fromWords.getString("pattern_value");

        //user_name = bundle_fromWords.getString("userName");
        //picIndex = bundle_fromWords.getString("picIndex");
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 204) {
                ...
                if (s.contains("server: update database successfully")) {
                    Toast.makeText(ClothInfo2Activity.this, s, Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(ClothInfo2Activity.this, s, Toast.LENGTH_LONG).show();
                }
            }
    ...
    private int UserScore() {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FeedbackData.put("length_value", length_value);
                FeedbackData.put("sleeve_value", sleeve_value);
                FeedbackData.put("collar_value", collar_value);
                FeedbackData.put("model_value", model_value);
                FeedbackData.put("pattern_value", pattern_value);
                FeedbackData.put("feedbackLevel", feedbackLevel);
                new ClothInfo2Activity.feedback().start();
                //finish();
            }
        };
